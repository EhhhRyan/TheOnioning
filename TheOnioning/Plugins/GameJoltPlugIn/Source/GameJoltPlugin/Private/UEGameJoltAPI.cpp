...
UUEGameJoltAPI* UUEGameJoltAPI::Create(UObject* WorldContextObject) {
	...
	UUEGameJoltAPI* fieldData = (UUEGameJoltAPI*)StaticConstructObject(UUEGameJoltAPI::StaticClass());
...
*	@param	Scoreboard_ID	The id of the high score table that you want to submit to. If left blank the score will be submitted to the primary high score table.
