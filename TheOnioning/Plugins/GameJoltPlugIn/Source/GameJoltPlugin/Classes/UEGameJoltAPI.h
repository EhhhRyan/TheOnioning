...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Your Game ID"), Category = "GameJolt")
		int32 GetGameID();
	UFUNCTION(Blueprintcallable, meta = (DisplayName = "Set Your Game ID"), Category = "GameJolt")
	...
	UFUNCTION(Blueprintcallable, meta = (DisplayName = "Set Your Game Private Key"), Category = "GameJolt")
